...
#Constants
tools_total_count = exploded.shape[0]
...
st.write("### Explore a wide range of AI tools and understand the AI tools market")
st.write("""** ** """)
...
st.write("#### Percentage of  :green["+st.session_state.category+"] tools: ",round(st.session_state.count/tools_total_count*100,2),':green[%]' )
